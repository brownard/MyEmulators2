...
<a
 href="http://www.rsasecurity.com">RSA Data Security, Inc.</a> requires 
...
namespace Hasher
{
    ...
    public class MD4_Old
    {
        ...
        /// <summary>
        /// The FileSize in bytes of the input block to the transformation algorithm
        /// </summary>
        ...
        {
            // make sure we don't exceed input's allocated FileSize/length
        ...
        public static byte[] GetByteHashFromBytes(byte[] b)
        {
            MD4_Old md4 = new MD4_Old();
        ...
        /// <param name="b">byte to hash</param>
        /// <returns>String that contains the hex of the hash</returns>
        public static string GetHexHashFromByte(byte b)
        {
        ...
        private static string bytesToHex(byte[] a, int len)
        {
            ...
            StringBuilder sb = new StringBuilder((len - 2) / 2);	// This should be the final FileSize
